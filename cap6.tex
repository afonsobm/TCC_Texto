...
\subsection{Aumento de Dados do DRR}

Esta seção apresenta os resultados do aumento de dados do DRR. Para isso, foram gerados três exemplos de RIRSMs. Suas configurações
...
\subsection{Aumento de Dados do T60}

Esta seção apresenta os resultados do aumento de dados do T60. Para isso, foram gerados três exemplos de RIRSMs. Suas configurações
...
\begin{figure} [H]
    \centering
    \includegraphics[scale=0.25]{rir-og-t2-dB.png}
...
\begin{figure} [H]
    \centering
    \includegraphics[scale=0.25]{rir-aug-t2-dB.png}
...
\subsection{Aumento de Dados de fala em campo distante}

Por último, esta seção apresenta os resultados do aumento de dados de AVCDs. Para isso, 
