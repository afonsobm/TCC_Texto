...
reverberadas em campo-distante (AVCDs) usando: amostras de voz anecóias (AVAs), RIRSM, sinais de ruído pontuais (SRPs) e de fundo (SRFs).
...
\begin{figure} [H]
    ...
    \caption{Exemplo de amostra de voz anecóia.}
