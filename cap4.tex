Este capítulo é dedicado ao desenvolvimento do segundo algoritmo de aumento de dados, onde são geradas as amostras de voz 
...
\begin{figure} [H]
    \centering
    \includegraphics[scale=0.65]{flow-voz-aug-ad.png}
