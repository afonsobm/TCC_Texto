...
\noindent
\textcolor{red}{\textbf{[FIGURA]} Exemplo de RIR antes e depois de fazer \textit{Data Augmentation} de DRR} \\
\textcolor{red}{\textbf{[FIGURA]} Exemplo de RIR mostrando o problema de intensidade resposta atrasada maior que o da adiantada}
...
\noindent
\textcolor{red}{\textbf{[FIGURA]} Exemplo de RIR antes e depois de fazer \textit{Data Augmentation} de T60} 