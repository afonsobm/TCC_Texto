Este capítulo é dedicado à implementação do primeiro algoritmo de aumento de dados, onde são geradas RIRs simuladas (RIRSM)
...
\begin{figure} [H]
    \centering
    \includegraphics[scale=0.6]{flow-rir-aug-ad.png}
